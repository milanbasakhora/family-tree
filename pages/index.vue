<template>
    <!-- Hero Section -->
    <!-- <section id="hero">
        <div class="bg-[url('/assets/images/hero.jpg')] h-screen bg-cover bg-center">
        ...
        <div
            ...
            <div
                ...
                <h1 class="text-4xl font-bold hover:-translate-y-1 duration-1000 drop-shadow-xl">Celebrate the legacy of
                    the Basakhora family.</h1>
                <p class="hover:-translate-y-1 duration-1000 drop-shadow-xl">Explore our rich heritage and honor our
                    ancestors through an interactive family tree.</p>
                <p class="hover:-translate-y-1 duration-1000 drop-shadow-xl">Uncover the roots and connect with
                    generations of our family history.</p>
